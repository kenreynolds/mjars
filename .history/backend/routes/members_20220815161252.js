...
router.delete("/api/members/:id", (req, res, next) => {
...
router.get("/api/members/:id", (req, res, next) => {
...
router.post("/api/members", (req, res, next) => {
...
router.put("/api/members/:id", (req, res, next) => {
  const member = new Member({
    _id: req.body.id,
    firstName: req.body.firstName,
    lastName: req.body.lastName,
