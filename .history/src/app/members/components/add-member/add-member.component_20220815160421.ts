...
export class AddMemberComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.showMemberInfo(this.member);
  ...
  showMemberInfo(memberInfo) {
    if (this.mode === 'edit') {
      ...
      this.addMemberForm.patchValue({
        ...
        'memberNotes': memberInfo.memberNotes,
        'state': memberInfo.state,
        'title': memberInfo.title,
        'zipCode': memberInfo.zipCode,
        'arrlMember': memberInfo.arrlMember,
        'licenseClass': memberInfo.licenseClass,
        'membershipType': memberInfo.membershipType,
        'emailAddress': memberInfo.emailAddress,
        'callSign': memberInfo.callSign,
