...
export class AddMemberComponent implements OnInit {
  ...
  addMember() {
    if (this.addMemberForm.valid) {
      ...
      this.membersService.createMember(newMemberData);
      this.clearFormData();
      this.scrollToTop();
    }
  }
  ...
  showMemberInfo() {
    if (this.mode === 'edit') {
        this.addMemberForm.get('address').setValue(this.member.address);
        this.addMemberForm.get('city').setValue(this.member.city);
        this.addMemberForm.get('interests').setValue(this.member.interests);
        this.addMemberForm.get('memberNotes').setValue(this.member.memberNotes);
        this.addMemberForm.get('state').setValue(this.member.state);
        this.addMemberForm.get('title').setValue(this.member.title);
        this.addMemberForm.get('zipCode').setValue(this.member.zipCode);
        this.addMemberForm.get('arrlMember').setValue(this.member.arrlMember);
        this.addMemberForm.get('licenseClass').setValue(this.member.licenseClass);
        this.addMemberForm.get('membershipType').setValue(this.member.membershipType);
        this.addMemberForm.get('emailAddress').setValue(this.member.emailAddress);
        this.addMemberForm.get('callSign').setValue(this.member.callSign);
        this.addMemberForm.get('firstName').setValue(this.member.firstName);
        this.addMemberForm.get('lastName').setValue(this.member.lastName);
        this.addMemberForm.get('phoneNumber').setValue(this.member.phoneNumber);
    }
  }
